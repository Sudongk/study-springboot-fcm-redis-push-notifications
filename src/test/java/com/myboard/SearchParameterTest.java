...
public class SearchParameterTest {
    ...
    @Test
    @DisplayName("검색 requestDto인 SearchParameter 생성 - 성공")
    ...
    @Test
    @DisplayName("검색 requestDto인 SearchParameter 생성 - 실패 - start 값이 음수인 경우")
    ...
    @Test
    @DisplayName("검색 requestDto인 SearchParameter 생성 - 실패 - 유효하지 않은 size 값인 경우")
